...
- **推荐** [`desktop-note-0.3.22-x64.zip`](https://github.com/nirrra/desktop-note/releases/download/v0.3.22/desktop-note-0.3.22-x64.zip)：解压一次后双击 `桌面便签.exe`，后续启动更快
- 或 [`desktop-note-0.3.22-x64.exe`](https://github.com/nirrra/desktop-note/releases/download/v0.3.22/desktop-note-0.3.22-x64.exe)：单文件便携版，无需解压，但每次启动会慢一些
