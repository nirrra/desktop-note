...
- **推荐** [`desktop-note-0.3.25-x64.zip`](https://github.com/nirrra/desktop-note/releases/download/v0.3.25/desktop-note-0.3.25-x64.zip)：解压一次后双击 `桌面便签.exe`，后续启动更快
- 或 [`desktop-note-0.3.25-x64.exe`](https://github.com/nirrra/desktop-note/releases/download/v0.3.25/desktop-note-0.3.25-x64.exe)：单文件便携版，无需解压，但每次启动会慢一些
...
- 拖动手柄排序，或 `Alt + ↑/↓`；顶栏时钟按钮可将未完成待办按时间排序
