...
assert.match(main, /function shouldKeepHoverPreview/);
assert.match(main, /dockedEdge && !isEdgePreviewed/);
...
assert.match(previewRenderer, /bridge\.releaseHover/);
...
assert.match(main, /function isManagedMoveEcho/);
assert.match(main, /function stillAttachedToEdge/);
assert.match(main, /isApplyingManagedBounds/);
assert.match(main, /if \(isProgrammaticMove && isManagedMoveEcho\(bounds, programmaticMoveTarget\)\) return false/);
assert.match(main, /rightOvershootHideWorks/);
assert.match(main, /isPreviewWindowOpen\(previewWindow\)/);
...
assert.match(main, /function getCollapsedBounds/);
assert.match(main, /function setDockedPresentation/);
